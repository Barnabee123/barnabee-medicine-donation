...
def donations(request):
    ...
    email=request.POST.get('email')
    user = Donations(donor_name=donor_name, medicine_name=medicine_name, phone=phone,pickup_address=pickup_address,receiver_address=receiver_address, expiry_date=expiry_date,purpose=purpose,accepted_by=accepted_by,email=email)
    user.save()
